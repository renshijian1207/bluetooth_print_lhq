...
import 'package:bluetooth_print_lhq/bluetooth_print_lhq_model.dart';
...
class _MyAppState extends State<MyApp> {
  BluetoothPrintLhq bluetoothPrint = BluetoothPrintLhq.instance;
  ...
  Future<void> initBluetooth() async {
    ...
    bluetoothPrint.state.listen((state) {
      ...
      switch (state) {
        case BluetoothPrintLhq.CONNECTED:
          setState(() {
            _connected = true;
            tips = 'connect success';
          });
          break;
        case BluetoothPrintLhq.DISCONNECTED:
          setState(() {
            _connected = false;
                    ...
                    children: <Widget>[
                      ...
                      OutlineButton(
                        ...
                        onPressed:  _connected?() async {
                          ...
                          list.add(LineText(type: LineText.TYPE_QRCODE, content: 'qrcode i', size:4, align: LineText.ALIGN_CENTER, linefeed: 1));
