...
import 'bluetooth_print_lhq_model.dart';

class BluetoothPrintLhq {
  static const String NAMESPACE = 'bluetooth_print_lhq';
  ...
  static BluetoothPrintLhq _instance = new BluetoothPrintLhq._();

  static BluetoothPrintLhq get instance => _instance;
  ...
  Stream<BluetoothDevice> scan({
    ...
    yield* BluetoothPrintLhq.instance._methodStream
