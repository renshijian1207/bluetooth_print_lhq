...
/** BluetoothPrintLhqPlugin */
public class BluetoothPrintLhqPlugin implements MethodCallHandler, RequestPermissionsResultListener {
  private static final String TAG = "BluetoothPrintLhqPlugin";
  private int id = 0;
  ...
  public static void registerWith(Registrar registrar) {
    final BluetoothPrintLhqPlugin instance = new BluetoothPrintLhqPlugin(registrar);
    registrar.addRequestPermissionsResultListener(instance);
  }

  BluetoothPrintLhqPlugin(Registrar r){
    this.registrar = r;
